...
{
	printf("\nLosowa vs Losowa\n");
	simulateGame(WITHOUT_REFILL, SMART, 13, 1000, RANDOMLY, RANDOMLY, SIM_RANK_DEFAULT, SIM_MIN_CARD_NUM_POINTING, SIM_SEED_DEFAULT);

	printf("\nLosowa vs Wsciekla\n");
	simulateGame(WITHOUT_REFILL, SMART, 13, 1000, RANDOMLY, OFFENSIVE, SIM_RANK_DEFAULT, SIM_MIN_CARD_NUM_POINTING, SIM_SEED_DEFAULT);

	printf("\nLosowa vs Pokojowa\n");
	simulateGame(WITHOUT_REFILL, SMART, 13, 1000, RANDOMLY, DEFENSIVE, SIM_RANK_DEFAULT, SIM_MIN_CARD_NUM_POINTING, SIM_SEED_DEFAULT);

	printf("\nWsciekla vs Wsciekla\n");
	simulateGame(WITHOUT_REFILL, SMART, 13, 1000, OFFENSIVE, OFFENSIVE, SIM_RANK_DEFAULT, SIM_MIN_CARD_NUM_POINTING, SIM_SEED_DEFAULT);

	printf("\nWsciekla vs Pokojowa\n");
	simulateGame(WITHOUT_REFILL, SMART, 13, 1000, OFFENSIVE, DEFENSIVE, SIM_RANK_DEFAULT, SIM_MIN_CARD_NUM_POINTING, SIM_SEED_DEFAULT);

	printf("\nPokojowa vs Pokojowa\n");
	simulateGame(WITHOUT_REFILL, SMART, 13, 1000, DEFENSIVE, DEFENSIVE, SIM_RANK_DEFAULT, SIM_MIN_CARD_NUM_POINTING, SIM_SEED_DEFAULT);
}
